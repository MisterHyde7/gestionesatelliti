			...
			<main class="flex-shrink-0">
			  ...
			  <div class='card'>
				    ...
				    <div class='card-body'>
							...
							<form:form modelAttribute="edit_satellite_attr" method="post" action="${pageContext.request.contextPath}/satellite/edit" class="row g-3" novalidate="novalidate">
								...
								<div class="col-md-3">
								    ...
								    <spring:bind path="stato">
									    <select class="form-select ${status.error ? 'is-invalid' : ''}" id="stato" name="stato" required>
									    	...
									    	<option value="IN_MOVIMENTO" ${edit_satellite_attr.stato == 'ATTIIN_MOVIMENTOVO'?'selected':''}>IN_MOVIMENTO</option>
