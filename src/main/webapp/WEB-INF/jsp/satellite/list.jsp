										...
										<tr>
											...
											<td>
												...
												<c:if test="${satelliteItem.dataLancio == null}">
													<a class="btn btn-outline-info btn-sm" href="${pageContext.request.contextPath}/satellite/lancia/${satelliteItem.id }">Lancia</a>
												</c:if>
												<c:if test="${satelliteItem.dataLancio != null &&  satelliteItem.dataRientro == null}">
													<a class="btn btn-outline-warning btn-sm" href="${pageContext.request.contextPath}/satellite/rientra/${satelliteItem.id }">Rientra</a>
												</c:if>
											</td>
										</tr>
									</c:forEach>
